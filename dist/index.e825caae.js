 ...
 */ !function(e, t) {
    ...
    function P(e) {
        return void 0 === e && (e = {}), T || (T = function(e) {
            ...
            const s = C(), a = r(), i = a.navigator.platform, n = t || a.navigator.userAgent, l = {
                ios: !1,
                android: !1
    ...
    const A = (e, t)=>{
        ...
        if (!s || !t || t < 0) return;
        t = Math.min(t, s);
        const a = "auto" === e.params.slidesPerView ? e.slidesPerViewDynamic() : Math.ceil(e.params.slidesPerView), i = e.activeIndex, r = i + a - 1;
    ...
    class J {
        constructor(){
            ...
            }), l.browser = L(), l.eventsListeners = {}, l.eventsAnyListeners = [], l.modules = [
                ...l.__modules__
    ...
    const pe = [
        ...
        function(e) {
            ...
            function n(e) {
                let s;
                return e && "string" == typeof e && t.isElement && (s = t.el.shadowRoot.querySelector(e), s) ? s : (e && ("string" == typeof e && (s = [
        ...
        function(e) {
            ...
            function h() {
                ...
                if (!e.el) return;
                let s;
                "string" == typeof e.el && t.isElement && (s = t.el.shadowRoot.querySelector(e.el)), s || "string" != typeof e.el || (s = [
                ...
                ], s.length > 1 && (s = s.filter((e)=>y(e, ".swiper")[0] === t.el)[0])), Array.isArray(s) && 1 === s.length && (s = s[0]), Object.assign(t.pagination, {
                    el: s
                }), s = o(s), s.forEach((s)=>{
            ...
            a("changeDirection", ()=>{
                ...
                if (Array.isArray(r) || (r = [
                    r
                ].filter((e)=>!!e)), t.params.pagination.el && t.params.pagination.hideOnClick && r && r.length > 0 && !a.classList.contains(t.params.pagination.bulletClass)) {
        ...
        function(e) {
            ...
            const w = (e, t, s)=>{
                ...
                if (u = n(u), m = n(m), u && u.forEach((t)=>w(t, r, e.nextSlideMessage)), m && m.forEach((t)=>w(t, r, e.prevSlideMessage)), v()) (Array.isArray(t.pagination.el) ? t.pagination.el : [
                    t.pagination.el
                ]).forEach((e)=>{
        ...
        function(e) {
            ...
            const c = ()=>{
                i("hashChange");
                const e = o.location.hash.replace("#", ""), s = t.slidesEl.querySelector(`[data-swiper-slide-index="${t.activeIndex}"]`);
                ...
                const e = t.slidesEl.querySelector(`[data-swiper-slide-index="${t.activeIndex}"]`), s = e ? e.getAttribute("data-hash") || e.getAttribute("data-history") : "";
            ...
            s({
                ...
                setTranslate: ()=>{
                    ...
                    for(let l = 0; l < e.length; l += 1){
                        ...
                        const w = t.virtual && t.params.virtual.enabled ? t.virtual.from + l : l, b = (w === s || w === s - 1) && c > 0 && c < 1 && (r || t.params.cssMode) && n < i, y = (w === s || w === s + 1) && c < 0 && c > -1 && (r || t.params.cssMode) && n > i;
                        if (b || y) {
...
//# sourceMappingURL=index.e825caae.js.map
