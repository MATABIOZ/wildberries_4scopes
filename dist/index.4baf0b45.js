...
function quickViewClick(event) {
    if (event.target.classList.contains("card__btn-quick-view")) {
        ...
        const selectedCard = (0, _cardsStoreJs.CardsStore).getSelectedCard(cardId);
        if (selectedCard) {
...
function addToBasketClick(event) {
    if (event.target.classList.contains("card__btn-add-basket") || event.target.classList.contains("card-modal__btn-add-basket")) {
        ...
        if (selectedCard) {
            ...
            (0, _alertServiceJs.AlertService).access("Товар добавлен в корзину");
        }
    }
}
...
},{}],"5mRkp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "UsersStore", ()=>UsersStore);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ksauc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CardsStore", ()=>CardsStore);
class CardsStore {
    static cards = [];
    static getCards() {
        return this.cards;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cq7m8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "AlertService", ()=>AlertService);
