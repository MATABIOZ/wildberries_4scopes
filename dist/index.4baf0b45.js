...
})({"3PPRB":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "b8f52f624baf0b45";
"use strict";
...
},{}],"eLI9n":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addCards", ()=>addCards);
var _cardsApiJs = require("../../core/API/cardsApi.js");
var _orderJs = require("../../core/utils/order/order.js");
var _showMoreJs = require("../../core/utils/cards/show-more.js");
const cardsBox = document.querySelector(".cards__inner");
function addCards(arrayElements) {
    for (let element of arrayElements)cardsBox.appendChild(createCardElement(element));
    (0, _showMoreJs.hiddenCards)();
}
...
function quickViewClick(event) {
    if (event.target.classList.contains("card__btn-quick-view")) {
        ...
        const selectedCard = (0, _cardsApiJs.alyaStore).find((card)=>card.id === cardId);
        if (selectedCard) {
...
function addToBasketClick(event) {
    if (event.target.classList.contains("card__btn-add-basket") || event.target.classList.contains("card-modal__btn-add-basket")) {
        ...
        if (selectedCard) {
            ...
            let basketArray = [];
            if (basketStore) basketArray = JSON.parse(basketStore);
...
function removeAllFromBasketClick(event) {
    if (event.target.classList.contains("card__btn-del-all-basket")) localStorage.removeItem("basketStore");
}
...
function filterCardsByTitle(title) {
    ...
    for(let i = 0; i < cardTitles.length; i++){
        ...
        if (cardTitles[i].textContent === title) card.style.display = "flex";
...
window.addEventListener("DOMContentLoaded", (0, _cardsApiJs.getCards));
...
},{"../../core/API/cardsApi.js":"2ckNJ","../../core/utils/order/order.js":"j9F6e","../../core/utils/cards/show-more.js":"8qr3A","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2ckNJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "alyaStore", ()=>alyaStore);
parcelHelpers.export(exports, "getCards", ()=>getCards);
parcelHelpers.export(exports, "getDataCards", ()=>getDataCards);
var _productCardJs = require("../../page-modules/product-card/product-card.js");
let alyaStore = [];
function getCards() {
    fetch("https://646f451109ff19b12086e48a.mockapi.io/wildberries/cards").then((response)=>{
        if (response.status === 200) return response.json();
        else throw Error(response);
    }).then((arrayElements)=>{
        alyaStore = arrayElements;
        (0, _productCardJs.addCards)(arrayElements);
    }).catch((error)=>{
        alert(error);
    });
}
function getDataCards() {
    return fetch("https://646f451109ff19b12086e48a.mockapi.io/wildberries/cards").then((response)=>response.json()).then((arrayElements)=>{
...
},{"../../page-modules/product-card/product-card.js":"eLI9n","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gkKU3":[function(require,module,exports) {
...
},{}],"j9F6e":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function linkStoreToUserData() {
    const store = JSON.parse(localStorage.getItem("basketStore"));
    const token = (0, _usersStoreJs.getTokenStore)();
    if (token) (0, _authenticationApiJs.AuthenticationApi).changeUserOrders(token, store);
}

},{"../../API/authenticationApi.js":"7yKf7","../../../stores/users-store/users-store.js":"5mRkp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7yKf7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "AuthenticationApi", ()=>AuthenticationApi);
class AuthenticationApi {
    ...
    static setUser(login, password, token) {
        return new Promise((resolve, reject)=>{
            fetch(this.userUrl, {
                ...
                else reject(new Error("Failed to set user"));
            }).catch((error)=>reject(error));
        });
    }
    static getUserByLogin(userData) {
        return fetch(this.userUrl).then((response)=>response.json()).then((data)=>{
    ...
    static async changeUserOrders(userToken, orders) {
        ...
        return fetch(`${this.userUrl}/${userId}`, {
            ...
            else throw new Error("Failed to change user data");
        }).catch((error)=>{
            throw error;
        });
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5mRkp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getTokenStore", ()=>getTokenStore);
parcelHelpers.export(exports, "removeTokenStore", ()=>removeTokenStore);
parcelHelpers.export(exports, "setTokenStore", ()=>setTokenStore);
var _keys = require("../../core/consts/keys");
function getTokenStore() {
    return sessionStorage.getItem((0, _keys.USER_TOKEN));
}
function removeTokenStore() {
    return sessionStorage.removeItem((0, _keys.USER_TOKEN));
}
function setTokenStore(value) {
    return sessionStorage.setItem((0, _keys.USER_TOKEN), value);
}

},{"../../core/consts/keys":"efZ2Y","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"efZ2Y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "USER_TOKEN", ()=>USER_TOKEN);
const USER_TOKEN = "token";

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8qr3A":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "hiddenCards", ()=>hiddenCards);
...
function hiddenCards() {
    ...
    for(i; i < numberOfVisibleCards && i < allCards.length; i++)allCards[i].classList.add("card_active");
    allCards.forEach((element)=>{
        if (element.classList.contains("card_active")) setTimeout(()=>element.style.opacity = "1", 100);
    });
    if (i >= allCards.length) showMoreBtn.style.display = "none";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["3PPRB","eLI9n"], "eLI9n", "parcelRequire5951")

//# sourceMappingURL=index.4baf0b45.js.map
